let ailment = require('../api/ailments.js')

let newAilments = [
    {
        ailmentName: 'Coughing',
        ...
        img: 'chlorella.jpg',
        herbId: ['Cancer', 'detoxification', 'fibromyalgia', 'radiation treatment side effects', 'stimulates the immune system', 'colds', 'protecting the body against toxic metals', 'slowing the aging process'],
        oilId: 20,
        supId: 20,
        // inStock: Boolean
    },    {
...
ailment.newAilment(newAilments)
  .then(ailment => {
    console.log('Saved Ailments', ailment)
  })